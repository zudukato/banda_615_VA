...
screens.screenRAD405.__index = screens.screenRAD405
screens.screenRAD405._label1:setLocation(0,0)
screens.screenRAD405._label2:setLocation(0,6)
screens.screenRAD405._label3:setLocation(0,11)
screens.screenRAD405._label1:reSize(40, 5)
screens.screenRAD405._label2:reSize(40, 5)
screens.screenRAD405._label3:reSize(40, 5)
...
function screens.screenRAD405:new(screenName,textLabel1,textLabel2,textLabel3,segmentText)
    if type(screenName) ~= "string" then return print("screenName is not a string") end
    if brmUtilities.tableFind(screens._names,screenName) then return print("screen already exist") end
    local instance = {}
    ...
    table.insert(screens._names, screenName)
...
---@return number
function screens.screenRAD405:show()
...
function screens.screenRAD405:clear()
